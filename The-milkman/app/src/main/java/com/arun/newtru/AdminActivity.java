...
public class AdminActivity extends AppCompatActivity {
    ...
    public void checkComplaints(View v){
        Intent intent = new Intent(this, ViewReportNew.class);
        intent.putExtra("COMPLAINTS", (Serializable) complaints);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tickReceiver  = new BroadcastReceiver(){
            ...
            public void onReceive(Context context, Intent intent) {
                if(intent.getAction().compareTo(Intent.ACTION_TIME_TICK)==0){
                    ...
                    if(cal.get(Calendar.HOUR_OF_DAY)==20 && cal.get(Calendar.MINUTE)==00) {
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener(){
            @Override
            public void onDataChange(DataSnapshot dataSnapshot){
                for(DataSnapshot newcomplaint: dataSnapshot.getChildren()){
                    complaints.add(newcomplaint.getValue(complaint.class));
                }
                //progressDialog.dismiss();
            }
            ...
            public void onCancelled(DatabaseError dbError){
                ...
                progressDialog.dismiss();
                //startActivity(new Intent(ViewReportNew.this, AdminActivity.class));
                //finish();
            }
        });
