...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private ViewPager viewPager; // usertoken editText
    ...
    List<String> userids = new ArrayList<String>();                     //for storing retrieved newuser tokens from firebase
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if ((curr == 2 && mLastPage == 1) || (curr == 2 && mLastPage == 2)) {    //validation done when page changes from 1->2
                //adding validators
